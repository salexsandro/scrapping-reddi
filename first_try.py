...
OUTPUT_CSV = "./dataset_analisado_100.csv"
...
sentiment_model = pipeline(
    ...
    max_length=512,
    truncation=True
    # device=0 -> esse tópico apenas deve ser ativado caso for rodar em uma gpu
)
...
topic_model = BERTopic(
    ...
    min_topic_size=15 # Agrupa no mínimo 15 relatos para formar um assunto.
)
